...
class _snackState extends State<snack> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(150, 255, 190, 152),
        title: const Text('S N A C K'),
      ),
      body: Column(
        children: [
          MyTabBar(
